...
#
# Pester tests for uninstall-native.ps1
# Run: Invoke-Pester ./tests/test_uninstall_native.ps1 -Output Detailed

BeforeAll {
    $ScriptDir = Split-Path -Parent $PSScriptRoot
    $UninstallScript = Join-Path $ScriptDir "uninstall-native.ps1"
}

Describe "uninstall-native.ps1 argument parsing" {
...
Describe "uninstall-native.ps1 not-installed guard" {
...
Describe "uninstall-native.ps1 release install removal" {
...
Describe "uninstall-native.ps1 workspace preservation" {
...
Describe "uninstall-native.ps1 wrapper removal" {
...
Describe "uninstall-native.ps1 PATH cleanup" {
...
Describe "uninstall-native.ps1 installation detection" {
